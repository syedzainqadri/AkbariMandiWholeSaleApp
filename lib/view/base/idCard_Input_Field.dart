...
class IdCardInputField extends StatefulWidget {
  ...
  @override
  _IdCardInputFieldState createState() => _IdCardInputFieldState();
}

class _IdCardInputFieldState extends State<IdCardInputField> {
