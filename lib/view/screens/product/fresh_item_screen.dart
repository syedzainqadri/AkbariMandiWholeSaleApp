...
class FreshItemScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Provider.of<ProductProvider>(context, listen: false).getFreshItemList(
      context,
      false,
    ...
    return Scaffold(
      appBar: CustomAppBar(title: getTranslated('fresh_items', context)),
      body: Scrollbar(
                      ...
                      child: Consumer<ProductProvider>(
                        builder: (context, productProvider, child) {
                          return productProvider.freshItemList != null
                              ? productProvider.freshItemList.length > 0
                                  ? GridView.builder(
                                      gridDelegate:
                                      ...
                                      shrinkWrap: true,
                                      itemCount:
                                          productProvider.freshItemList.length,
