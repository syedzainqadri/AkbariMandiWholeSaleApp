...
import 'package:akbarimandiwholesale/data/repository/cart_repo.dart';
...
import 'package:akbarimandiwholesale/data/repository/location_repo.dart';
import 'package:akbarimandiwholesale/data/repository/notification_repo.dart';
import 'package:akbarimandiwholesale/data/repository/onboarding_repo.dart';
import 'package:akbarimandiwholesale/data/repository/order_repo.dart';
import 'package:akbarimandiwholesale/data/repository/product_details_repo.dart';
...
import 'provider/banner_two_provider.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => BannerTwoRepo(dioClient: sl()));
  ...
  sl.registerFactory(() => BannerTwoProvider(bannerTwoRepo: sl()));
